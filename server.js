...
// Set the view engine to use EJS and as the default views directory
app.set('view engine', 'ejs');
app.set('views', __dirname + '/public/views/');

// Set static directory for express
...
var NON_INTERACTIVE_CLIENT_ID = 'YOUR CLIENT KEY HERE';
var NON_INTERACTIVE_CLIENT_SECRET = 'SECRET KEY HERE';
...
var authData = {
    ...
    audience: 'ENTER YOUR AUDIENCE HERE'
};
